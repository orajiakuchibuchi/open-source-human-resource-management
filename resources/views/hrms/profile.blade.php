                ...
                <div class="box box-success">
                    <div class="panel">
                        ...
                        <div class="panel-body pn pb5 text-center">
                            ...
                            <img src="{{($details->photo) ? ('photos/'. $details->photo) : '/assets/img/avatars/profile_pic.png'}}" 
                        ...
                        @endif
                        {!! Form::open(['class' => 'form-horizontal', 'route' => 'update-employee-picture',
                             'method' => 'POST', 'id' => 'changeProfileImageForm','files'=> true]) !!}
                            <input type="file" class="gui-file" name="photo" id="photo_upload">
                            <label class="col-md-3 control-label"></label>
                            <input type="text" class="gui-file" name="emp_id" style="display: none;" value="{{$details->id}}">
                            <input type="submit" class="gui-file" value="Submit">
                        {!! Form::close() !!}
                    </div>
                </div>
