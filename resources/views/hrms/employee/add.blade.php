                    ...
                    <div class="allcp-form">
                        ...
                        <form method="post" action="/" id="custom-form-wizard">
                            <div class="wizard steps-bg steps-left">
                                ...
                                <h4 class="wizard-section-title">
                                    <i class="fa fa-file-text pr5"></i> Next Of Kin Details </h4>
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="kin_first_name" class="gui-input fs13"
                                                       name="kin_first_name"
                                                       value="@if($emps && $emps->employee->kin_first_name){{$emps->employee->kin_first_name}} @endif"/>
                                                <label class="field-icon">
                                                    <i class="fa fa-calendar"></i>
                                                </label>
                                            @else
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="kin_last_name" class="gui-input fs13"
                                                       name="kin_last_name"
                                                       value="@if($emps && $emps->employee->kin_last_name){{$emps->employee->kin_last_name}} @endif"/>
                                                <label class="field-icon">
                                                    <i class="fa fa-calendar"></i>
                                                </label>
                                            @else
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="option-group field">
                                            <label class="field option mb5">
                                                <input type="radio" value="0" name="kin_gender" id="kin_gender"
                                                       @if(isset($emps))@if($emps->employee->kin_gender == '0')checked @endif @endif>
                                                <span class="radio"></span>Male</label>
                                            <label class="field option mb5">
                                                <input type="radio" value="1" name="gender" id="kin_gender"
                                                       @if(isset($emps))@if($emps->employee->kin_gender == '1')checked @endif @endif>
                                                <span class="radio"></span>Female</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" id="datepickerdob" class="gui-input fs13"
                                                       name="kin_dob"
                                                       value="@if($emps && $emps->employee->kin_dob){{$emps->employee->kin_dob}} @endif"/>
                                                <label class="field-icon">
                                                    <i class="fa fa-calendar"></i>
                                                </label>
                                            @else
