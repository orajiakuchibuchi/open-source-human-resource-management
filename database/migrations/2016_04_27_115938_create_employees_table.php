...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->date('date_of_resignation')->nullable(true);
            $table->string('notice_period')->nullable(true);
            $table->date('last_working_day')->nullable(true);
            $table->tinyInteger('full_final')->nullable(true);
