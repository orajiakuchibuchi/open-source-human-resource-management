<?php
//Routes for authentication[login, register, resetPassword]
...
Route::group(['middleware' => ['auth']], function ()
{
    ...
    Route::post('update-employee-picture', ['as' => 'update-employee-picture', 'uses' => 'EmpController@updateEmployeePicure']);

    Route::get('employee-manager', ['as' => 'employee-manager', 'uses' => 'EmpController@showEmployee']);

    Route::get('employee-kin-manager', ['as' => 'employee-kin-manager', 'uses' => 'EmpController@showEmployeeKin']);
